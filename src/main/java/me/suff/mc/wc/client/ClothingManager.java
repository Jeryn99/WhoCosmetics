...
public class ClothingManager {
    ...
    public static void setup() {
        ...
        addData(WCItems.STETSON.get(), new ClothingData(WCItems.STETSON.get()).setModelForSlot(new StetsonModel(), EquipmentSlotType.HEAD).ignoreSteve());
        ...
        addData(WCItems.SPACE_HELMET.get(), new ClothingData(WCItems.SPACE_HELMET.get(), "space_suit").setModelForSlot(new SpaceSuitModel(EquipmentSlotType.HEAD), EquipmentSlotType.HEAD).setModeller(Modeller.ANGELA).hideWear());
        addData(WCItems.SPACE_CHEST.get(), new ClothingData(WCItems.SPACE_CHEST.get(), "space_suit").setModelForSlot(new SpaceSuitModel(EquipmentSlotType.CHEST), EquipmentSlotType.CHEST).setModeller(Modeller.ANGELA).hideWear());
        addData(WCItems.SPACE_LEGS.get(), new ClothingData(WCItems.SPACE_LEGS.get(), "space_suit").setModelForSlot(new SpaceSuitModel(EquipmentSlotType.LEGS), EquipmentSlotType.LEGS).setModeller(Modeller.ANGELA).hideWear());
