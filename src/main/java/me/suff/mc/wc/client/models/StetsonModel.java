...
public class StetsonModel extends BipedModel<LivingEntity> implements LivingArmor {
    ...
    public StetsonModel() {
        ...
        Head.setTextureOffset(0, 16).addBox(-4.0F, -10.0F, -4.0F, 8.0F, 3.0F, 8.0F, 0.6F, false);
        Head.setTextureOffset(0, 28).addBox(-4.0F, -10.0F, -4.0F, 8.0F, 3.0F, 8.0F, 0.8F, false);
        Head.setTextureOffset(0, 0).addBox(-7.0F, -8.0F, -7.0F, 14.0F, 2.0F, 14.0F, 0.0F, false);
