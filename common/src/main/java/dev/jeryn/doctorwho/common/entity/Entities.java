...
public class Entities {
    ...
    public static final RegistrySupplier<EntityType<Nitro9Entity>> NITRO_9 = ENTITY_TYPES.register("nitro_9", () -> EntityType.Builder.<Nitro9Entity>of((entityType, level) -> new Nitro9Entity(level), MobCategory.MISC).sized(0.9F, 0.9F).build(WhoCosmetics.MOD_ID + ":nitro_9"));
