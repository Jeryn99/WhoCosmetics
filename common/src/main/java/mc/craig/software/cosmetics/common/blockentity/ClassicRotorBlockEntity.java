...
public class ClassicRotorBlockEntity extends BlockEntity implements AnimatedBlockEntityBase {



    public ClassicRotorBlockEntity(BlockPos blockPos, BlockState blockState) {
        super(WCBlockEntities.CLASSIC_ROTOR.get(), blockPos, blockState);
    }
