...
public class ClassicDoorsModel extends HierarchicalModel {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition left_door = partdefinition.addOrReplaceChild("left_door", CubeListBuilder.create().texOffs(42, 0).addBox(0.0F, -48.0F, 0.0F, 16.0F, 48.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offset(-8.0F, 24.0F, -8.0F));

        PartDefinition right_door = partdefinition.addOrReplaceChild("right_door", CubeListBuilder.create().texOffs(0, 0).addBox(-16.0F, -48.0F, 0.0F, 16.0F, 48.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offset(24.0F, 24.0F, -8.0F));
