...
public class RecipeProvider extends net.minecraft.data.recipes.RecipeProvider {
    ...
    protected void buildRecipes(Consumer<FinishedRecipe> consumer) {
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, WCItems.ACES_BAT.get()).pattern(" I ").pattern(" I ").pattern(" G ").define('I', Items.IRON_INGOT).define('G', Items.STICK).unlockedBy("has_crafting_table", has(Blocks.CRAFTING_TABLE)).save(consumer);
